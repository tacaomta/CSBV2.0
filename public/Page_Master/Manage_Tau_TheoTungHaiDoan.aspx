<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrangChu.Master" AutoEventWireup="true" CodeBehind="Manage_Tau_TheoTungHaiDoan.aspx.cs" Inherits="CSB.Page_Master.Manage_Tau_TheoTungHaiDoan" %>
        ...
        $(document).ready(function () {
            ...
            if (donvi == null) {
                $.ajax({
                    async: false,
                    type: "GET",
                    url: linkapi + "flotilla_by_squadron?id=" + Group_OnUnitID,
                    dataType: "json",

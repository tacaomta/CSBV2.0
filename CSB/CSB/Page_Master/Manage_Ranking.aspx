    ...
    <script>
        ...
        function loadTableRank() {
            $('table[id=table_rank]').each(function () {
                ...
                $('.col-sm-12').first().html('<div class="btn-group"><button onclick="btn_Load_listrank()" class="btn btn-lg btn-primary mb-3"><span class="glyphicon glyphicon-refresh"></span> &nbsp;Load dữ liệu</button><button id="btn_addrank" onclick="btn_addrank()" class="btn btn-lg btn-primary mb-3" data-toggle="modal" data-target="#model-add-rank" style=" padding - top: 4px;margin - top: -4px;"><span class="glyphicon glyphicon-plus-sign"></span> Thêm cấp bậc</button></div>');
            });
        };

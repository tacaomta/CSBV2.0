            ...
            <div class="section">
                <div class="section-header">
                    ...
                    <div class="section-header-breadcrumb">
                        ...
                        <div class="breadcrumb-item active"><a href="#" style="color: #01b5f9">Quản lý cán bộ, nhân viên</a></div>
                    </div>
                </div>
                <div class="section-header">
                    <div class="col-md-12">
    ...
    <script>
        ...
        function loadTableStaff() {
            $('table[id=table_Staff]').each(function () {
                ...
                $('.col-sm-12').first().html('<div class="btn-group"><button onclick="btn_Load_liststaff()" class="btn btn-lg btn-primary mb-3"><span class="glyphicon glyphicon-refresh"></span> &nbsp;Load dữ liệu</button><button id="btn_addstaff" onclick="btn_addstaff()" class="btn btn-lg btn-primary mb-3" style=" padding - top: 4px;margin - top: -4px;"><span class="glyphicon glyphicon-plus-sign"></span> Thêm mới</button></div>');

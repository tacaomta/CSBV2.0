        ...
        function loadDataList_THOIGIANLAMVIECMAY(nam) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var i = 1;
                    $.each(data, function (key, item) {
                        tabletext += "<tr><td>" + i + "</td><td>" + item.THONGTINMAY.THONGSOCOBAN.KYHIEU + "</td><td>" + item.NAMTRUOC + "</td><td>" + item.QUYI + "</td><td>" + item.QUYII + "</td><td>" + item.QUYIII + "</td><td>" + item.QUYIV + "</td><td>" + item.TONG + '</td><td><div style="width: max-content;"><a href="#" class="edit" title="Sửa" data-toggle="modal" data-target="#model-edit-THOIGIANLAMVIECMAY"  onclick="onclick_edit_THOIGIANLAMVIECMAY(`' + item.ID + '`,`' + item.THONGTINMAY.ID + '`,`' + item.THONGTINMAY.THONGSOCOBAN.KYHIEU + '`,`' + item.QUYI + '`,`' + item.QUYII + '`,`' + item.QUYIII + '`,`' + item.QUYIV + '`,`' + item.NAMTRUOC + '`,`' + item.TONGTRONGNAM + '`,`' + item.TONG + '`)"><i class="material-icons">&#xE254;</i></a><a href="#" class="delete" title="Xóa" onclick="delete_THOIGIANLAMVIECMAY(`' + item.ID + '`)"><i class="material-icons">&#xE872;</i></a></div></td></tr>';
                        i = i + 1;
                    });
                    tabletext += "</tbody>";

    ...
    <script>
        ...
        function loadTableDegree() {
            $('table[id=table_degree]').each(function () {
                ...
                $('.col-sm-12').first().html('<div class="btn-group"><button onclick="btn_Load_listdegree()" class="btn btn-lg btn-primary mb-3"><i class="bi-arrow-repeat"></i> Load dữ liệu</button><button id="btn_adddegree" onclick="btn_adddegree()" class="btn btn-lg btn-primary mb-3" data-toggle="modal" data-target="#model-add-degree" style=" padding - top: 4px;margin - top: -4px;"><i class="bi bi-plus-circle"></i> Thêm bằng cấp</button></div>');
            });
        };

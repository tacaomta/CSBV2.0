<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrangChu.Master" AutoEventWireup="true" CodeBehind="Manage_Tau_TheoTungVung.aspx.cs" Inherits="CSB.Page_Master.Manage_Tau_TheoTungVung" %>
    ...
    <script>
        ...
        function Load_DonVi(OnUnitID) {
            $.ajax({
                async: false,
                type: "GET",
                url: linkapi + "squadrons_by_region?id=" + OnUnitID,
                dataType: "json",
                success: function (data) {
                    $("#mainMenu_list").empty();
                    $.each(data, function (key, item) {

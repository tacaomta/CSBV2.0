        ...
        function loadDataList_Main_Engine(Ship_ID) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#table_maychinh_wrapper .row .col-sm-12').first().html('<button id="btn_addMayChinh" onclick="btn_addMayChinh()" class="btn btn-info" data-toggle="modal" data-target="#model-add-MainEngine" style="height: 40px; margin-bottom: 8px; margin-top: -4px; font-size: 14px;">Thêm máy chính</button><button id="btn_etwMayChinh" onclick="exportToWord(`contentMayChinh`,`Thông tin máy chính tàu ' + shipName + '`)" class="btn btn-info" style="height: 40px; margin-bottom: 8px; margin-top: -4px; font-size: 14px;">Xuất báo cáo</button><button id="prt_etwMayChinh" onclick="In_Content(`contentMayChinh`)" class="btn btn-info" style="height: 40px; margin-bottom: 8px; margin-top: -4px; font-size: 14px;">In</button>');

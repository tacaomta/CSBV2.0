    ...
    <div id="form1">
        <div class="section" style="background-color: #fff; padding-bottom: 5px;">
            <div class="section-header" style="background-color: #fff;">
                <h4 id="title_manage_staff" style="color: black; margin: 0; margin-left: 15px;">QUẢN LÝ CHỨC VỤ</h4>                        
                <div class="section-header-breadcrumb" style="margin-right: 15px;">
                    ...
                    <div class="breadcrumb-item active"><a href="#" style="color: #01b5f9; font-size: 16px;">Quản lý chức vụ</a></div>
                </div>
            </div>
            ...
            <div class="modal-content">
                <div class="card auth_form" style="margin-bottom: 0px">
                    ...
                    <div class="modal-footer">
                        ...
                        <button onclick="Close_AddPosition()" type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (key, item) {
                        tabletext += "<tr><td style='text-align: center;'>" + i + "</td><td>" + item.Name + "</td><td>" + item.Note + '</td><td><div style="display: flex; justify-content: space-around;"><a href="#" class="edit" title="Sửa" data-toggle="modal" data-target="#model-edit-position"  onclick="editposition(`' + item.ID + '`,`' + item.Name + '`,`' + item.Note + '`)"><i class="material-icons">&#xE254;</i></a><a href="#" class="delete" title="Xóa" onclick="delete_position(`' + item.ID + '`)"><i class="material-icons">&#xE872;</i></a></div></td></tr>';
                        i = i + 1;
                    });
                    tabletext += "</tbody>";
        ...
        function loadTablePosition() {
            $('table[id=table_position]').each(function () {
                ...
                $('.col-sm-12').first().html('<div class="btn-group"><button onclick="btn_Load_listposition()" class="btn btn-lg btn-secondary mb-3"><i class="bi-arrow-repeat"></i> Load dữ liệu</button><button id="btn_addposition" onclick="btn_addposition()" class="btn btn-lg btn-secondary mb-3" data-toggle="modal" data-target="#model-add-position"><i class="bi bi-plus-circle"></i> Thêm chức vụ</button></div>');
            });
        };

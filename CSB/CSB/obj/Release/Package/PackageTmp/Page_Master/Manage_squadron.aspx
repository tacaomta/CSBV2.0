    ...
    <script>
        ...
        function loadTableSquadron() {
            $('table[id=table_squadron]').each(function () {
                ...
                $('.col-sm-12').first().html('<button id="btn_addsquadron" onclick="btn_addsquadron()" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#model-add-squadron" style="height: 35px; padding - top: 4px;margin - top: -4px;"><span class="glyphicon glyphicon-plus-sign"></span> Thêm hải đoàn</button>');
            });
        };

                ...
                <div class="section">
                    <div class="col-md-12">
                        <div class="btn-group">
                            ...
                            <button id="btn_add_KiemTraKT" onclick="btn_add_KiemTraKT()" class="btn btn-secondary mb-2" data-toggle="modal" data-target="#model-add-KiemTraKT" style="padding-top: 4px;"><i class="bi bi-plus-circle"></i>&nbsp; Thêm mới</button>
                        </div>

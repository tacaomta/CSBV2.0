...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <form id="form2" runat="server">
        ...
        <asp:Button ID="Button1" runat="server" Text="Xuất file word" OnClick="Button1_Click" />
        <asp:Button ID="Button2" runat="server" Text="Xuất file pdf" OnClick="Button2_Click" />
        <asp:Button ID="Button3" runat="server" Text="Xuất file excel" OnClick="Button3_Click" />
        <asp:Button ID="Button4" runat="server" Text="In" OnClick="Button4_Click" />
        <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="True"  Height="50px" ReportSourceID="CrystalReportSource1" ToolPanelWidth="200px" Width="350px" hidden="hidden"/>
        ...
        function loadDataList_Main_Engine(Ship_ID) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#table_maychinh_wrapper .row .col-sm-12').first().html('<div class="btn-group"><button id="btn_addMayChinh" onclick="btn_addMayChinh()" class="btn btn-info" data-toggle="modal" data-target="#model-add-MainEngine" style="height: 40px; margin-bottom: 8px; margin-top: -4px; font-size: 14px;">Thêm máy chính</button><button id="btn_etwMayChinh" onclick="exportToWord(`contentMayChinh`,`Thông tin máy chính tàu ' + shipName + '`)" class="btn btn-info" style="height: 40px; margin-bottom: 8px; margin-top: -4px; font-size: 14px;">Xuất báo cáo</button><button id="prt_etwMayChinh" onclick="In_Content(`contentMayChinh`)" class="btn btn-info" style="height: 40px; margin-bottom: 8px; margin-top: -4px; font-size: 14px;">In báo cáo</button></div>');
        ...
        function loadDataList_Screw_System(Ship_ID) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#table_chanvit_wrapper .row .col-sm-12').first().html('<button id="btn_addScrewSystem" onclick="btn_addScrewSystem()" class="btn btn-info btn-lg col-md-6" data-toggle="modal" data-target="#model-add-ScrewSystem" style="height: 40px; margin-bottom: 8px; margin-top: -4px; font-size: 18px;">Thêm hệ trục chân vịt</button><button id="btn_etwMayChinh" onclick="exportToWord(`contentChanVit`,`Thông tin hệ thống chân vịt tàu ' + shipName + '`)" class="btn btn-info btn-lg col-md-6" style="height: 40px; margin-bottom: 8px; margin-top: -4px; font-size: 18px;">Xuất báo cáo</button>');
        ...
        function loadDataList_Secondary_Engine(ship_ID) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#tableSecondaryEngine_wrapper .row .col-sm-12').first().html('<button id="btn_addSecondaryEngine" onclick="btn_addSecondaryEngine()" class="btn btn-info btn-lg col-md-6" data-toggle="modal" data-target="#model-add-SecondaryEngine" style="height: 40px; margin-bottom: 8px; margin-top: -4px; font-size: 18px;">Thêm máy phụ</button><button id="btn_etwMayChinh" onclick="exportToWord(`contentMayPhu`,`Thông tin máy phụ tàu ' + shipName + '`)" class="btn btn-info btn-lg col-md-6" style="height: 40px; margin-bottom: 8px; margin-top: -4px; font-size: 18px;">Xuất báo cáo</button>');
        ...
        function loadDataList_WeaponMarine(ship_ID) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#table_KhiTai_wrapper .row .col-sm-12').first().html('<button id="btn_addWeaponMarine" onclick="btn_addWeaponMarine()" class="btn btn-info btn-lg col-md-6" data-toggle="modal" data-target="#model-add-WeaponMarine" style="height: 40px; margin-bottom: 8px; margin-top: -4px; font-size: 18px;">Thêm khí tài, hàng hóa</button><button id="btn_etwMayChinh" onclick="exportToWord(`contentKhiTai`,`Thông tin khí tài, hàng hải trên tàu ' + shipName + '`)" class="btn btn-info btn-lg col-md-6" style="height: 40px; margin-bottom: 8px; margin-top: -4px; font-size: 18px;">Xuất báo cáo</button>');

<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrangChu.Master" AutoEventWireup="true" CodeBehind="Information_User.aspx.cs" Inherits="CSB.Page_Master.Information_User" %>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="panel-footer text-right" style="padding: 0 10px;">
                                        <a href="javascript: history.go(-1)" class="btn btn-secondary"><span class="bi-arrow-return-left"></span>&nbsp;Quay lại</a>

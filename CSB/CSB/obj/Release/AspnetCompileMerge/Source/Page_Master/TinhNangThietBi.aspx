...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="modal">
                                    ...
                                    <%--<div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" id="add-MAYCHINH-THONGBAODINHMUC-SUACHUACUOICUNG" readonly="readonly" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" step="any" id="add-MAYCHINH-THONGBAODINHMUC-MUCCANHBAO" readonly="readonly" min="0" class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="number" step="any" id="add-MAYCHINH-THONGBAODINHMUC-DINHMUCSUACHUA" required="required" min="1" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="number" step="any" id="add-MAYCHINH-THONGBAODINHMUC-DINHMUCTHONGBAO" required="required" min="1" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group row">
                                                <label class="col-sm-4 col-form-label">Công suất: </label>
                                                <div class="col-sm-8">
                                                    <input type="text" id="edit-MAYCHINH-THONGSOCOBAN-CONGSUAT" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label class="col-sm-5 col-form-label">Định mức sửa chữa (h): </label>
                                                <div class="col-sm-7">
                                                    <input type="number" step="any" id="edit-MAYCHINH-THONGBAODINHMUC-DINHMUCSUACHUA" required="required" min="1" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label class="col-sm-5 col-form-label">Định mức thông báo (h): </label>
                                                <div class="col-sm-7">
                                                    <input type="number" step="any" id="edit-MAYCHINH-THONGBAODINHMUC-DINHMUCTHONGBAO" required="required" min="1" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <%--                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-4 col-form-label">Sửa chữa cuối cùng: </label>
                                                    <div class="col-sm-8">
                                                        <input type="text" id="add-MAYPHU-THONGBAODINHMUC-SUACHUACUOICUNG" readonly="readonly" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-4 col-form-label">Mức cành báo: </label>
                                                    <div class="col-sm-8">
                                                        <input type="number" step="any" id="add-MAYPHU-THONGBAODINHMUC-MUCCANHBAO" readonly="readonly" min="0" class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label class="col-sm-5 col-form-label">Định mức sửa chữa (h): </label>
                                                <div class="col-sm-7">
                                                    <input type="number" step="any" id="add-MAYPHU-THONGBAODINHMUC-DINHMUCSUACHUA" required="required" min="1" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label class="col-sm-5 col-form-label">Định mức thông báo (h): </label>
                                                <div class="col-sm-7">
                                                    <input type="number" step="any" id="add-MAYPHU-THONGBAODINHMUC-DINHMUCTHONGBAO" required="required" min="1" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label class="col-sm-5 col-form-label">Định mức sửa chữa (h): </label>
                                                <div class="col-sm-7">
                                                    <input type="number" step="any" id="edit-MAYPHU-THONGBAODINHMUC-DINHMUCSUACHUA" required="required" min="1" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <%--<div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-4 col-form-label">Sửa chữa cuối cùng: </label>
                                                    <div class="col-sm-8">
                                                        <input type="text" id="add-MAYCHUYENDUNG-THONGBAODINHMUC-SUACHUACUOICUNG" readonly="readonly" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-4 col-form-label">Mức cành báo: </label>
                                                    <div class="col-sm-8">
                                                        <input type="number" step="any" id="add-MAYCHUYENDUNG-THONGBAODINHMUC-MUCCANHBAO" readonly="readonly" min="0" class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label class="col-sm-5 col-form-label">Định mức sửa chữa (h): </label>
                                                <div class="col-sm-7">
                                                    <input type="number" step="any" id="add-MAYCHUYENDUNG-THONGBAODINHMUC-DINHMUCSUACHUA" required="required" min="1" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label class="col-sm-5 col-form-label">Định mức thông báo (h): </label>
                                                <div class="col-sm-7">
                                                    <input type="number" step="any" id="add-MAYCHUYENDUNG-THONGBAODINHMUC-DINHMUCTHONGBAO" required="required" min="1" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label class="col-sm-5 col-form-label">Định mức sửa chữa (h): </label>
                                                <div class="col-sm-7">
                                                    <input type="number" step="any" id="edit-MAYCHUYENDUNG-THONGBAODINHMUC-DINHMUCSUACHUA" required="required" min="1" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label class="col-sm-5 col-form-label">Định mức thông báo (h): </label>
                                                <div class="col-sm-7">
                                                    <input type="number" step="any" id="edit-MAYCHUYENDUNG-THONGBAODINHMUC-DINHMUCTHONGBAO" required="required" min="1" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form id="form-add-THANVO" onsubmit="return false">
                        <div class="card auth_form" style="margin-bottom: 0px">
                            <div class="modal-header">
                                <h4 class="title-modal-banve font-weight-bold"> Thêm thân vỏ trên tàu</h4>
                            </div>
                            <div class="modal-body">
                                <div class="row clearfix ">
                                    <div style="width: 100%; float: left; padding: 10px">
                                        <div class="form-group" style="display: flex">
                                            <label class="col-md-5 control-label"><strong>Ký hiệu vật liệu   : </strong></label>
                                            <div class="col-md-7">
                                                <input type="text" class="form-control" id="add-THANVO-KYHIEUVATLIEU" placeholder="Ký hiệu vật liệu" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div style="width: 100%; float: left; padding: 10px">
                                        <div class="form-group" style="display: flex">
                                            <label class="col-md-5 control-label"><strong>Số khoang kín nước   : </strong></label>
                                            <div class="col-md-7">
                                                <input type="number" min="0" step="any" class="form-control" id="add-THANVO-SOKHOANGKINNUOC" >
                                            </div>
                                        </div>
                                    </div>
                                    <div style="width: 100%; float: left; padding: 10px">
                                        <div class="form-group" style="display: flex">
                                            <label class="col-md-5 control-label"><strong>Số sườn tàu   : </strong></label>
                                            <div class="col-md-7">
                                                <input type="number" min="0" step="any" class="form-control" id="add-THANVO-SOSUONTAU">
                                            </div>
                                        </div>
                                    </div>
                                    <div style="width: 100%; float: left; padding: 10px">
                                        <div class="form-group" style="display: flex">
                                            <label class="col-md-5 control-label"><strong>Số két dầu cháy   : </strong></label>
                                            <div class="col-md-7">
                                                <input type="number" min="0" step="any" class="form-control" id="add-THANVO-SOKETDAUCHAY">
                                            </div>
                                        </div>
                                    </div>
                                    <div style="width: 100%; float: left; padding: 10px">
                                        <div class="form-group" style="display: flex">
                                            <label class="col-md-5 control-label"><strong>Số két dầu nhờn  : </strong></label>
                                            <div class="col-md-7">
                                                <input type="number" min="0" step="any" class="form-control" id="add-THANVO-SOKETDAUNHON" placeholder="Nhập số lượng" required min="0">
                                            </div>
                                        </div>
                                    </div>
                                    <div style="width: 100%; float: left; padding: 10px">
                                        <div class="form-group" style="display: flex">
                                            <label class="col-md-5 control-label"><strong>Số két nước  : </strong></label>
                                            <div class="col-md-7">
                                                <input type="number" min="0" step="any" class="form-control" id="add-THANVO-SOKETNUOC" placeholder="Nhập số lượng" required min="0">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal-footer">
                                <button type="submit" onclick="add_THANVO()" class="btn btn-info"> Thêm</button>
                                <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
                            </div>
                        </div>
                    </form>
        ...
        <div class="modal fade" id="model-edit-THANVO" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form id="form-edit-THANVO" onsubmit="return false">
                        ...
                        <div class="card auth_form" style="margin-bottom: 0px">
                            <div class="modal-header">
                                <h4 class="title-modal-banve font-weight-bold"> Sửa thân vỏ trên tàu</h4>
                            </div>
                            <div class="modal-body">
                                <div class="row clearfix ">
                                    <div style="width: 100%; float: left; padding: 10px">
                            ...
                            <div class="modal-footer">
                                <button type="submit" onclick="edit_THANVO()" class="btn btn-info"> Sửa</button>
                                <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
                            </div>
                        </div>
                    </form>
                                ...
                                <div class="row clearfix ">
                                    <div style="width: 100%; float: left; padding: 10px">
                                        <div class="form-group" style="display: flex">
                                            <label class="col-md-5 control-label"><strong>Ký hiệu   : </strong></label>
                                            <div class="col-md-7">
                                                <input type="text" class="form-control" id="add-MAYNENKHI-KYHIEU" placeholder="Nhập tên trang thiết bị" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div style="width: 100%; float: left; padding: 10px">
                                        <div class="form-group" style="display: flex">
                                            <label class="col-md-5 control-label"><strong>Số lượng   : </strong></label>
                                            <div class="col-md-7">
                                                <input type="number" min="0" step="any" class="form-control" id="add-MAYNENKHI-SOLUONG" placeholder="Nhập ký hiệu" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div style="width: 100%; float: left; padding: 10px">
                                        <div class="form-group" style="display: flex">
                                            <label class="col-md-5 control-label"><strong>Áp suất (Kg/cm3)  : </strong></label>
                                            <div class="col-md-7">
                                                <input type="number" min="0" step="any" class="form-control" id="add-MAYNENKHI-APSUAT" placeholder="Nhập số lượng" required min="0">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal fade" id="model-edit-MAYNENKHI" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form id="form-edit-MAYNENKHI" onsubmit="return false">
                                ...
                                <div class="row clearfix ">
                                    <div style="width: 100%; float: left; padding: 10px">
                                        <div class="form-group" style="display: flex">
                                            <label class="col-md-5 control-label"><strong>Ký hiệu   : </strong></label>
                                            <div class="col-md-7">
                                                <input type="text" class="form-control" id="edit-MAYNENKHI-KYHIEU" placeholder="Nhập tên trang thiết bị" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div style="width: 100%; float: left; padding: 10px">
                                        <div class="form-group" style="display: flex">
                                            <label class="col-md-5 control-label"><strong>Số lượng   : </strong></label>
                                            <div class="col-md-7">
                                                <input type="number" min="0" step="any" class="form-control" id="edit-MAYNENKHI-SOLUONG" placeholder="Nhập ký hiệu" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div style="width: 100%; float: left; padding: 10px">
                                        <div class="form-group" style="display: flex">
                                            <label class="col-md-5 control-label"><strong>Áp suất (Kg/cm3)  : </strong></label>
                                            <div class="col-md-7">
                                                <input type="number" min="0" step="any" class="form-control" id="edit-MAYNENKHI-APSUAT" placeholder="Nhập số lượng" required min="0">
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        function loadDataList_MAYCHINH() {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (key, item) {
                        tabletext += "<tr ";
                        if (item.THONGBAODINHMUC.MUCCANHBAO == 1) {
                            tabletext += 'style="background-color: #fff7de;"><td style="text-align: center;" title="Máy ' + item.THONGSOCOBAN.KYHIEU + ' còn ' + item.THONGBAODINHMUC.THOIGIANCONLAI + ' giờ hoạt động đến lần bảo dưỡng tiếp theo"><i style="color: #ff8100;" class="bi bi-exclamation-triangle-fill"></i> ' + i + '</td>';
                        }
                        else if (item.THONGBAODINHMUC.MUCCANHBAO == 2) {
                            tabletext += 'style="background-color: #f9bcbc;"><td style="text-align: center;" title="Máy ' + item.THONGSOCOBAN.KYHIEU + ' đã quá hạn bảo dưỡng ' + (0 - Number(item.THONGBAODINHMUC.THOIGIANCONLAI)) + ' giờ"><i style="color: #f30000;" class="bi bi-x-circle-fill"></i> ' + i + '</td>';
                        }
                        else {
            ...
            $('table[id=table-MAYCHINH]').each(function () {
                var table1 = $(this).DataTable({
                    ...
                    "columns": [
                        ...
                        { name: 'TÌNH TRẠNG HIỆN TẠI', width: 180 },
            ...
            if (form.checkValidity() == true) {
                if (parseInt($("#add-MAYCHINH-THONGBAODINHMUC-DINHMUCSUACHUA").val()) > parseInt($("#add-MAYCHINH-THONGBAODINHMUC-DINHMUCTHONGBAO").val())) {
                    var MAYCHINH = {
                        ...
                        THONGBAODINHMUC: {
                            SUACHUACUOICUNG: $("#add-MAYCHINH-THONGBAODINHMUC-SUACHUACUOICUNG").val(),
                            MUCCANHBAO: $("#add-MAYCHINH-THONGBAODINHMUC-MUCCANHBAO").val(),
        ...
        function onclick_edit_MAYCHINH(ID, KYHIEU, NAMSANXUAT, NOISANXUAT, NAMLAPRAP, VITRILAPRAP, SOHIEUMAY, CONGSUAT, VONGQUAY, CHIEUQUAY, NGUONKHOIDONG, HETHONGDIEUKHIEN, TRONGLUONG, DAI, RONG, CAO, TIEUTU, TRUNGTU, DAITU, DIENAP, TANSO, KYHIEULYHOP_BOGIAMVONG, SOHIEULYHOP_BOGIAMVONG, TYSOTRUYEN, KHOPNOICUNG, KHOPNOIMEM, CUROA, KYHIEUVONGBI, SUACHUACUOICUNG, MUCCANHBAO, THOIGIANCONLAI, DINHMUCSUACHUA, DINHMUCTHONGBAO, TINHTRANGHIENTAI) {
            ...
            $("#edit-MAYCHINH-THONGBAODINHMUC-SUACHUACUOICUNG").val(SUACHUACUOICUNG);
            $("#edit-MAYCHINH-THONGBAODINHMUC-MUCCANHBAO").val(MUCCANHBAO);
            ...
            if (form.checkValidity() == true) {
                if (parseInt($("#edit-MAYCHINH-THONGBAODINHMUC-DINHMUCSUACHUA").val()) > parseInt($("#edit-MAYCHINH-THONGBAODINHMUC-DINHMUCTHONGBAO").val())) {
                    var MAYCHINH = {
                        ...
                        THONGBAODINHMUC: {
                            SUACHUACUOICUNG: $("#edit-MAYCHINH-THONGBAODINHMUC-SUACHUACUOICUNG").val(),
                            MUCCANHBAO: $("#edit-MAYCHINH-THONGBAODINHMUC-MUCCANHBAO").val(),
            ...
            if (form.checkValidity() == true) {
                if (parseInt($("#add-MAYPHU-THONGBAODINHMUC-DINHMUCSUACHUA").val()) > parseInt($("#add-MAYPHU-THONGBAODINHMUC-DINHMUCTHONGBAO").val())) {
                    var MAYPHU = {
                        ...
                        THONGBAODINHMUC: {
                            SUACHUACUOICUNG: $("#add-MAYPHU-THONGBAODINHMUC-SUACHUACUOICUNG").val(),
                            MUCCANHBAO: $("#add-MAYPHU-THONGBAODINHMUC-MUCCANHBAO").val(),
        ...
        function onclick_edit_MAYPHU(ID, KYHIEU, NAMSANXUAT, NOISANXUAT, NAMLAPRAP, VITRILAPRAP, SOHIEUMAY, CONGSUAT, VONGQUAY, CHIEUQUAY, NGUONKHOIDONG, HETHONGDIEUKHIEN, TRONGLUONG, DAI, RONG, CAO, TIEUTU, TRUNGTU, DAITU, DIENAP, TANSO, KYHIEULYHOP_BOGIAMVONG, SOHIEULYHOP_BOGIAMVONG, TYSOTRUYEN, KHOPNOICUNG, KHOPNOIMEM, CUROA, KYHIEUVONGBI, SUACHUACUOICUNG, MUCCANHBAO, THOIGIANCONLAI, DINHMUCSUACHUA, DINHMUCTHONGBAO, TINHTRANGHIENTAI) {
            ...
            $("#edit-MAYPHU-THONGBAODINHMUC-SUACHUACUOICUNG").val(SUACHUACUOICUNG);
            $("#edit-MAYPHU-THONGBAODINHMUC-MUCCANHBAO").val(MUCCANHBAO);
            ...
            if (form.checkValidity() == true) {
                if (parseInt($("#edit-MAYPHU-THONGBAODINHMUC-DINHMUCSUACHUA").val()) > parseInt($("#edit-MAYPHU-THONGBAODINHMUC-DINHMUCTHONGBAO").val())) {
                    var MAYPHU = {
                        ...
                        THONGBAODINHMUC: {
                            SUACHUACUOICUNG: $("#edit-MAYPHU-THONGBAODINHMUC-SUACHUACUOICUNG").val(),
                            MUCCANHBAO: $("#edit-MAYPHU-THONGBAODINHMUC-MUCCANHBAO").val(),
            ...
            if (form.checkValidity() == true) {
                if (parseInt($("#add-MAYCHUYENDUNG-THONGBAODINHMUC-DINHMUCSUACHUA").val()) > parseInt($("#add-MAYCHUYENDUNG-THONGBAODINHMUC-DINHMUCTHONGBAO").val())) {
                    var MAYCHUYENDUNG = {
                        ...
                        THONGBAODINHMUC: {
                            SUACHUACUOICUNG: $("#add-MAYCHUYENDUNG-THONGBAODINHMUC-SUACHUACUOICUNG").val(),
                            MUCCANHBAO: $("#add-MAYCHUYENDUNG-THONGBAODINHMUC-MUCCANHBAO").val(),
        ...
        function onclick_edit_MAYCHUYENDUNG(ID, KYHIEU, NAMSANXUAT, NOISANXUAT, NAMLAPRAP, VITRILAPRAP, SOHIEUMAY, CONGSUAT, VONGQUAY, CHIEUQUAY, NGUONKHOIDONG, HETHONGDIEUKHIEN, TRONGLUONG, DAI, RONG, CAO, TIEUTU, TRUNGTU, DAITU, DIENAP, TANSO, KYHIEULYHOP_BOGIAMVONG, SOHIEULYHOP_BOGIAMVONG, TYSOTRUYEN, KHOPNOICUNG, KHOPNOIMEM, CUROA, KYHIEUVONGBI, SUACHUACUOICUNG, MUCCANHBAO, THOIGIANCONLAI, DINHMUCSUACHUA, DINHMUCTHONGBAO, TINHTRANGHIENTAI) {
            ...
            $("#edit-MAYCHUYENDUNG-THONGBAODINHMUC-SUACHUACUOICUNG").val(SUACHUACUOICUNG);
            $("#edit-MAYCHUYENDUNG-THONGBAODINHMUC-MUCCANHBAO").val(MUCCANHBAO);
            ...
            if (form.checkValidity() == true) {
                if (parseInt($("#edit-MAYCHUYENDUNG-THONGBAODINHMUC-DINHMUCSUACHUA").val()) > parseInt($("#edit-MAYCHUYENDUNG-THONGBAODINHMUC-DINHMUCTHONGBAO").val())) {
                    var MAYCHUYENDUNG = {
                        ...
                        THONGBAODINHMUC: {
                            SUACHUACUOICUNG: $("#edit-MAYCHUYENDUNG-THONGBAODINHMUC-SUACHUACUOICUNG").val(),
                            MUCCANHBAO: $("#edit-MAYCHUYENDUNG-THONGBAODINHMUC-MUCCANHBAO").val(),
        ...
        function loadDataList_MAYNENKHI() {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    tabletext += "</tbody>";
                    $('#table-MAYNENKHI').html(tabletext);
                    console.log("okGET");
                    loadTableMAYNENKHI();
                }, error: function (ret) {
                    console.log('errorGET');
        ...
        function loadTableMAYNENKHI() {
            $('table[id=table-MAYNENKHI]').each(function () {
                var table1 = $(this).DataTable({
                    destroy: true,
                    searching: false,
                    stateSave: true,
        ...
        function add_MAYNENKHI() {
            var form = document.getElementById("form-add-MAYNENKHI");
            console.log(form.checkValidity());
            if (form.checkValidity() == true) {
                var MAYNENKHI = {
                    KYHIEU: $("#add-MAYNENKHI-KYHIEU").val(),
                    SOLUONG: $("#add-MAYNENKHI-SOLUONG").val(),
                    APSUAT: $("#add-MAYNENKHI-APSUAT").val()
                };
                $.ajax({
                    type: "POST",
                    url: linkapi + "v2/insert_maynenkhi?id=" + getParameterByName("Ship_ID"),
                    dataType: "json",
                    data: JSON.stringify(MAYNENKHI),
                    contentType: "application/json",
                    success: function (data) {
                        toastSuccess("Thành công", "Thêm thông tin máy nén khí thành công.");
                        loadDataList_MAYNENKHI();
                    }, error: function (ret) {
                        toastError("Thất bại", "");
                    },
                    complete: function () { // Set our complete callback, adding the .hidden class and hiding the spinner.
                        $("#add-MAYNENKHI-KYHIEU").val("");
                        $("#add-MAYNENKHI-SOLUONG").val("");
                        $("#add-MAYNENKHI-APSUAT").val("");
                        $('#model-add-MAYNENKHI').modal("hide");
                    },
                });
            }
            return false;
        }
        function onclick_edit_MAYNENKHI(ID, KYHIEU, SOLUONG, APSUAT) {
            $('#edit-MAYNENKHI-ID').val(ID);
            $("#edit-MAYNENKHI-KYHIEU").val(KYHIEU);
            $("#edit-MAYNENKHI-SOLUONG").val(SOLUONG);
            $("#edit-MAYNENKHI-APSUAT").val(APSUAT);
        }
        function edit_MAYNENKHI() {
            var form = document.getElementById("form-edit-MAYNENKHI");
            console.log(form.checkValidity());
            if (form.checkValidity() == true) {
                var MAYNENKHI = {
                    ID: $("#edit-MAYNENKHI-ID").val(),
                    KYHIEU: $("#edit-MAYNENKHI-KYHIEU").val(),
                    SOLUONG: $("#edit-MAYNENKHI-SOLUONG").val(),
                    APSUAT: $("#edit-MAYNENKHI-APSUAT").val()
                };
                console.log(MAYNENKHI);
                $.ajax({
                    type: "PUT",
                    url: linkapi + "v2/update_maynenkhi?id=" + MAYNENKHI.ID,
                    dataType: "json",
                    data: JSON.stringify(MAYNENKHI),
                    contentType: "application/json",
                    success: function (data) {
                        toastSuccess("Thành công", "Cập nhật thông tin máy nén khí thành công.");
                        loadDataList_MAYNENKHI();
                    }, error: function (ret) {
                        console.log(ret.responseJSON.Message);
                        toastError("Thất bại", "");
                    ...
                    complete: function () { // Set our complete callback, adding the .hidden class and hiding the spinner.
                        $('#model-edit-MAYNENKHI').modal("hide");
                    },
                });
            }
            return false;
        }
        function delete_MAYNENKHI(id) {
            let text = "Bạn có chắc muốn xóa trang thiết bị này?";
            if (confirm(text) == true) {
                $.ajax({
                    url: linkapi + "v2/delete_maynenkhi?id=" + id,
                    type: "DELETE",
                }).done(function (res) {
                    loadDataList_MAYNENKHI();
                    toastSuccess("Thành công", "Xóa thông tin trang thiết bị thành công!");
